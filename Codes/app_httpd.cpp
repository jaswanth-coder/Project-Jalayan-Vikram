...
static esp_err_t index_handler(httpd_req_t *req){
 ...
 page += "<p align=center>";
 page += "<button style=background-color:blue;width:140px;height:40px onmousedown=getsend('ledon')><b>OPEN</b></button>";
 page += "<button style=background-color:blue;width:140px;height:40px onmousedown=getsend('ledoff')><b>CLOSE</b></button>";
 page += "</p>";
